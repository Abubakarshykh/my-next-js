            ...
            <div className="form_div xl:pt-4 lg:pt-3 md:pt-3 lg:w-[55%] w-full px-10 lg:p-3">          
                <form>
                    ...
                    <div className="btn_portion xl:pb-6 pl-3 pr-2">
                        <button className=" w-full sm:mt-2 mt-2 sm:ml-1 ml-1  text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-sm text-sm px-5 py-2 mr-2 mb-2 focus:outline-none ">Sign in</button>
                        <button 
                        type="button" 
                        className="sm:mt-2 mt-1 lg:mt-0 sm:ml-1 ml-1 w-full text-gray-900 bg-white hover:bg-gray-100 border border-gray-200 focus:ring-4 focus:outline-none focus:ring-gray-100 font-medium rounded-md text-sm px-5 py-2.5 text-center inline-flex items-center justify-center mr-2 mb-2">
                            <svg 
                            ...
                            clip-rule="evenodd">
                                ...
                                <path d="M166667 333333c44999 0 82776-14815 110370-40370l-52593-40742c-14074 9815-32963 16667-57777 16667-44074 0-81481-29073-94816-69258l-1954 166-51447 39815-673 1870c27407 54444 83704 91852 148890 91852z"
                                 fill="#34a853"/><path d="M71851 199630c-3518-10370-5555-21482-5555-32963 0-11482 2036-22593 5370-32963l-93-2209-52091-40455-1704 811C6482 114444 1 139814 1 166666s6482 52221 17777 74814l54074-41851m0 0z" 
                                 fill="#fbbc04"/><path d="M166667 64444c31296 0 52406 13519 64444 24816l47037-45926C249260 16482 211666 1 166667 1 101481 1 45185 37408 17777 91852l53889 41853c13520-40185 50927-69260 95001-69260m0 0z" fill="#ea4335"/></svg>
                            Sign in with Google
                        </button>
                        <span className="flex text-cente justify-center pt-3 lg:pt-1 xl:pt-5">
                            <p className="font-normal">Don’t have an account?</p>
                            <Link href={'/Signup'}><p className="font-semibold text-blue-600 hover:underline">Sign up</p>
                            </Link>
                        </span>
                    </div>
                </form>
