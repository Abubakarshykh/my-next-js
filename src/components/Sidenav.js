 ...
 <aside id='separator-sidebar' className='fixed top-0 left-0 z-40 md:w-[17rem] h-screen transition-transform -translate-x-full sm:translate-x-0' aria-label='Sidebar'>
    <div className='h-screen sm:h-screen px-3 overflow-y-auto bg-[#0d44b3]'>
        <span className='flex py-2'>
            ...
            width={30} height={30} 
            alt=''/>
            <Link href='/Overview' className='text-white  flex text-lg font-medium px-2 pt-2'>CROWD<p className='text-white font-light text-lg '>WRK</p></Link>
        </span>
       ...
       <ul className='pt-10 space-y-1 font-medium lg:pl-4 lg:pr-4'>
          <li>
          ...
          <div className='flex text-white gap-3 border-t lg:mt-5 pt-2'>
            <Image src='/images/Avatar.png' alt='' width={20} height={20} className= 'w-8 h-8 ml-2 mt-3'/>
