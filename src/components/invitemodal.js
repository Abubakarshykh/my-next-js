...
export default function Invitemodal() {
    ...
    return (
        ...
        <>
            <button
                data-modal-target="authentication-modal-invite"
                data-modal-toggle="authentication-modal-invite"
                className="gap-2 ml-auto text-white bg-blue-600 hover:bg-blue-700 focus:ring-2 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm md:px-5 px-4 py-2 text-center inline-flex items-center  mr-[3.4rem] mb-4 "
                type="button">
                    <svg 
                    ...
                    className="w-5 h-5 ">
                        ...
                        </svg>Send invites</button>
            {/* <!-- Main modal --> */}
            <div
                id="authentication-modal-invite"
                tabindex="-1"
                aria-hidden="true"
                ...
                <div className="relative w-full max-w-md max-h-full">
                    ...
                    <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
                     ...
                     ml-auto inline-flex items-center dark:hover:bg-gray-800 dark:hover:text-white"
                            data-modal-hide="authentication-modal-invite">
                            <svg
                                aria-hidden="true"
                                className="w-5 h-5"
                                fill="currentColor"
                        ...
                        <div className="px-6 py-6 lg:px-8">
                            ...
                            <form className="space-y-6" action="#">
                                <div className="space-x-2 px-2 flex">
                                    <button data-modal-hide="authentication-modal-invite" type="button" className="w-[50%] text-gray-600 bg-white hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-md text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 border">Cancel</button>
                                    <button data-modal-hide="authentication-modal-invite" type="button" className="w-[50%] text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-md text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Get started</button>
                                    {/* <Share_modal/> */}
